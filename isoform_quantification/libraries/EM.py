...
def EM_hybrid_multi(ref_file_path,sr_sam_list,lr_sam_list,output_path,multi_mapping_filtering='best',threads=1,READ_JUNC_MIN_MAP_LEN=15,EM_choice='LIQA_modified',lr_weights=None,sr_weights=None):
    ...
    print('[INFO] Start quantification...',flush=True)
    if sr_sam_list:
        EM_algo_hybrid_multi(isoform_len_dict,isoform_gene_dict,gene_isoforms_dict,sr_sam_list,lr_align_dirs,output_path,threads,EM_choice,lr_weights=lr_weights,sr_weights=sr_weights)
    else:
